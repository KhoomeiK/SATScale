# sr data
python src/generate_sr_data.py data_nsnet/SATSolving/sr/train 300 --min_n 10 --max_n 40
python src/generate_sr_data.py data_nsnet/SATSolving/sr/valid 100 --min_n 10 --max_n 40
python src/generate_sr_data.py data_nsnet/SATSolving/sr/test 100 --min_n 10 --max_n 40
...
# 3-sat data
python src/generate_3-sat_data.py data_nsnet/SATSolving/3-sat/train 300 --min_n 10 --max_n 40
python src/generate_3-sat_data.py data_nsnet/SATSolving/3-sat/valid 100 --min_n 10 --max_n 40
python src/generate_3-sat_data.py data_nsnet/SATSolving/3-sat/test 100 --min_n 10 --max_n 40
...
# ca data
python src/generate_ca_data.py data_nsnet/SATSolving/ca/train 300 --min_n 10 --max_n 40
python src/generate_ca_data.py data_nsnet/SATSolving/ca/valid 100 --min_n 10 --max_n 40
python src/generate_ca_data.py data_nsnet/SATSolving/ca/test 100 --min_n 10 --max_n 40
